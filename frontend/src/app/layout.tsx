  ...
  return (
    <html lang="en" className="w-mod-js" suppressHydrationWarning>
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `WebFont.load({ google: { families: ["Inter:300,400,500,600,700", "Plus Jakarta Sans:300,400,500,600,700"] } });` }}></script>
